...
class ActorsTest extends TestCase
{
    ...
    /** @test */
    public function the_second_page_shows_correct_info()
    {
        Http::fake([
    ...
    private function fakeCombinedCredits(){
        return Http::response([
            'cast' => [
                [
                    "id" => 602,
