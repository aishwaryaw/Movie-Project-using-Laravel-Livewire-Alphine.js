...
class MoviesTest extends TestCase
{
    ...
    {
        Http::fake([
            'https://api.themoviedb.org/3/movies/popular'=>$this->fakePopularMovies(),
            'https://api.themoviedb.org/3/movies/now_playing1'=>$this->fakeNowPlayingMovies(),
    ...
    /** @test */
    public function view_a_movie(){

        Http::fake([
            'https://api.themoviedb.org/3/movie/1' => $this ->fakeSingleMovie()
        ]);
