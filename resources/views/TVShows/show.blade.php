...
<div class="show-info border-b border-gray-800">
    <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
        ...
        <div class="md:ml-24">
            <h2 class="text-4xl mt-4 md:mt-0 text-white font-semibold">{{ $show['name'] }}</h2>
            ...
            @foreach ($show['cast'] as $cast)
                <div class="mt-8">
                    <a href="{{route('actors.show', $cast['id']) }}">
                        <img src="{{ $cast['profile_path'] }}" alt="actor1" class="h-250 hover:opacity-75 transition ease-in-out duration-150">
                    </a>
                    <div class="mt-2">
