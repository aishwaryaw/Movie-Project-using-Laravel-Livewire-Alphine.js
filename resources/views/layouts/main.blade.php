...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-gray-700">
        <div class="flex flex-col md:flex-row items-center px-10 py-4 bg-gray-900 justify-between">
        <ul class="container mx-auto flex flex-col md:flex-row items-center text-white font-bold">
            <li>
        ...
        <div class="flex flex-col md:flex-row items-center md:mr-4">
            @livewire('search-dropdown')
           <div class="md:ml-4 mt-3 md:mt-0">
            <a href="#">
                <img src="/img/image.jpg" alt="avatar" class="rounded-full w-10 h-10">
            </a>
           </div>
        </div>
        </div>
